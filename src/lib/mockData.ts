...
export const mockShipments: Shipment[] = [
  {
    ...
    timeline: [
      ...
      { status: "Received", date: "Jun 05, 2026 14:30", location: "TradeFlow Hub JHB" },
    ...
    documents: [
      { name: "Commercial_Invoice_TF001.pdf", type: "Commercial Invoice", status: "Approved", uploadDate: "Jun 05, 2026" },
      { name: "Packing_List_TF001.pdf", type: "Packing List", status: "Approved", uploadDate: "Jun 05, 2026" },
      { name: "Bill_of_Lading_TF001.pdf", type: "Bill of Lading", status: "Approved", uploadDate: "Jun 06, 2026" }
    ],
    notes: [
      { date: "Jun 05, 2026 09:00", author: "Client Portal", content: "Shipment booked and scheduled for collection." },
      { date: "Jun 05, 2026 14:30", author: "TradeFlow JHB Hub", content: "Cargo received, inspected, and verified against packing list. Weights match." },
      ...
      { date: "Jun 07, 2026 08:00", author: "Fleet Control", content: "Consignment dispatched. Vehicle ID: TF-TRK-402 en route to Gaborone via N4." }
    ]
  },
  {
    waybill: "TF-202606-0002",
    origin: "Lusaka, ZM",
    ...
    timeline: [
      ...
      { status: "Received", date: "Jun 05, 2026 09:00", location: "TradeFlow Hub LUN" },
    ...
    documents: [
      { name: "Commercial_Invoice_TF002.pdf", type: "Commercial Invoice", status: "Approved", uploadDate: "Jun 04, 2026" },
      { name: "Packing_List_TF002.pdf", type: "Packing List", status: "Approved", uploadDate: "Jun 04, 2026" },
      { name: "Import_Permit_ZW_TF002.pdf", type: "Import Permit", status: "Flagged", uploadDate: "Jun 05, 2026" }
    ],
    notes: [
      { date: "Jun 04, 2026 11:00", author: "Client Portal", content: "Shipment booked. Heavy haul configuration requested." },
      { date: "Jun 05, 2026 09:00", author: "TradeFlow LUN Hub", content: "Machinery loaded and lashed. Pre-transit inspection completed." },
      { date: "Jun 06, 2026 07:30", author: "Fleet Control", content: "Vehicle TF-TRK-088 (Escorted Heavy Carrier) departed Lusaka." },
      { date: "Jun 07, 2026 13:15", author: "Chirundu Agent", content: "Vehicle arrived at Chirundu Border Post. Border queue is moderate." },
      { date: "Jun 07, 2026 14:00", author: "TradeFlow AI Compliance", content: "Flagged: Weight mismatch detected. Import permit lists 12,000 kg while commercial invoice lists 12,500 kg. Reviewing with customs agent." }
    ]
  },
  {
    waybill: "TF-202606-0003",
    origin: "Pretoria, ZA",
    ...
    timeline: [
      ...
      { status: "Received", date: "Jun 01, 2026 15:00", location: "TradeFlow Hub PTA" },
    ...
    documents: [
      { name: "Commercial_Invoice_TF003.pdf", type: "Commercial Invoice", status: "Approved", uploadDate: "Jun 01, 2026" },
      { name: "Packing_List_TF003.pdf", type: "Packing List", status: "Approved", uploadDate: "Jun 01, 2026" },
      { name: "Cert_of_Origin_SADC_TF003.pdf", type: "Certificate of Origin", status: "Approved", uploadDate: "Jun 02, 2026" },
      { name: "Bill_of_Lading_TF003.pdf", type: "Bill of Lading", status: "Approved", uploadDate: "Jun 03, 2026" }
    ],
    notes: [
      ...
      { date: "Jun 01, 2026 15:00", author: "TradeFlow PTA Hub", content: "Cargo received and stacked. Palletized fertilizer." },
      ...
      { date: "Jun 05, 2026 09:00", author: "TradeFlow Maputo Agent", content: "Arrived at local Maputo depot. Prepared for local delivery." },
